...
class Doctor {
    ...
    public static void doctorLoginMenu(String uName, String docName) throws Exception {
        ...
        System.out.println("Please Select by number:" +
                "\n 1: For All Doctors list" +
                "\n 2: For All booked appointments" +
                "\n 3: For All Patients Information" +
                "\n 4: To Exit");
        ...
        try (Scanner obj = new Scanner(System.in)) {
            ...
            if (!validate(Uname)) {
                try {
                    ...
                    // read each character from string and write into Field
                    ...
                    fw.close();
                    Thread.sleep(1000);
                    doctorLoginMenu(Uname, fullName);
                }
...
class Patient {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        System.out.println("--------------------------------------------------------------------------------");
        System.out.println();
        System.out.println("Please Select number for the follwing:" +
                "\n 1: Login as a Patient" +
                "\n 2: Register as Paitnet" +
        ...
        try (Scanner obj = new Scanner(System.in)) {
            ...
            if (!validate(Uname)) {
                try {
                    ...
                    // read each character from string and write into a file Writer
    ...
    public static void bookAppointment(String Name, String patName) {
        ...
        System.out.println("Please Select number of the follwoing: " +
                "\n 1: To View All registerd Doctors" +
                "\n 2: Select Doctor and Date of Appointment" +
                "\n 3: View your Booked Appointments" +
                "\n 4: Exit");
    ...
    // All the following Seven Mthods are all for Checking if card is valid or not.
...
class Admin {
    ...
    static void adminMenu() throws Exception {
        ...
        System.out.println("Please select number of the Following:" +
                "\n 1: To View All Registered Doctors" +
                "\n 2: To View All Registered Paitnets" +
                "\n 3: To View Appointments" +
                "\n 4: Remove Doctors" +
                "\n 5: Remove Patients" +
    ...
    public static void removeDoc(String lineContent) throws IOException {
